...
export default function Visualisations() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition space-y-6">
      ...
      {/* Dataset selector */}
      <div>
        <label className="block font-medium mb-2" htmlFor="dataset-select">
          Select Dataset:
        </label>
        <select
          id="dataset-select"
      ...
      {/* Chart type selector */}
      <div>
        <label className="block font-medium mb-2" htmlFor="chart-type">
          Select Chart Type:
        </label>
        <select
          id="chart-type"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block font-medium mb-2" htmlFor="x-axis">
            X-Axis:
          </label>
          <select
            id="x-axis"
        ...
        <div>
          <label className="block font-medium mb-2" htmlFor="y-axis">
            Y-Axis:
          </label>
          <select
            id="y-axis"
      ...
      <div className="bg-gray-50 border rounded p-6 text-center">
        <p className="text-gray-700">
          [Mock {selectedChart} chart of <strong>{selectedDataset}</strong> with X ={" "}
          <strong>{xAxis}</strong>, Y = <strong>{yAxis}</strong>]
        </p>
      </div>
